...
const PowerRemotePage = () => {
    return (
        <main className="bg-rtgray-900 min-h-screen font-exo2">
            <Header />
            <div className="px-6 mt-4">
                <div className="flex justify-between items-center border-b-2 border-rtyellow-200 pb-2">
                    <h1 className="text-white text-2xl font-bold">Power Remote</h1>
                    <button className="bg-rtyellow-200 text-black px-4 py-2 rounded-lg font-medium flex items-center">
                        Estimate my quote <FaArrowRight className="ml-2" />
                    </button>
                </div>
                <h2 className="text-rtyellow-200 text-5xl font-bold mt-8">Power Remote Cool Tagline</h2>
                <img src="/PowerRemote.png" alt="Power Remote" className="mt-4 w-full max-w-3xl mx-auto" />
                <h1 className="text-rtyellow-200 text-1xl font-bold mt-8">How it works?</h1>
                ...
                <h1 className="text-rtyellow-200 text-1xl font-bold mt-8">Why rooftop energy?</h1>
                
                {/* Review Card Section */}
                <div className="bg-rtgray-800 p-6 rounded-lg mt-6 max-w-3xl mx-auto text-white flex items-center">
                    ...
                    <div>
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <span className="text-rtyellow-200 text-xl font-bold mx-2">-33%</span>
