...
const Footer = () => {
    ...
    return (
        <footer className="bg-rtorange-200 text-black p-6 scale-100">
            {/* Social Links */}
            <div className="flex justify-center space-x-6 mb-6">
                {Object.entries(socialLinks).map(([platform, url]) => (
                    <a
                        ...
                        className="w-10 h-10 bg-rtorange-300 flex items-center justify-center rounded-full transition-colors duration-300 hover:bg-white"
                    >
                        <img
            ...
            {/* Divider */}
            <div className="w-3/4 mx-auto border-t-2 border-rtorange-300 my-6"></div>
