...
const AboutUs = () => {
        ...
        return (
            <SkeletonTheme baseColor="#262626" highlightColor="#333">
                <div className={`min-h-screen bg-rtgray-900 text-white ${exo2.className}`}>
                    ...
                    <section className="py-8 md:py-32 bg-rtgray-900">
                    ...
                    {/* Our Values skeleton */}
                    <section className="py-16 bg-rtgray-900">
                        <div className="container mx-auto px-4 max-w-[1440px]">
                    ...
                    <section className="py-32 bg-rtgray-900">
                    ...
                    {/* FAQ skeleton */}
                    <section className="pt-24 pb-24 bg-rtgray-900">
    ...
    return (
        <div className={`min-h-screen bg-rtgray-900 text-white ${exo2.className}`}>
                    ...
                    <div className="relative container mx-auto px-4 max-w-[1440px] flex flex-col items-center z-10">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-[16px] md:text-[20px] font-medium mb-8 max-w-2xl md:max-w-4xl text-center px-6 md:px-0">
                                <span className="text-rtwhite">Precision. Power. Progress. <br className="hidden md:block" /></span>
                                <span className="text-rtyellow-200">At Rooftop Energy</span> , we partner with businesses to unlock the true potential of solar power. <br className="hidden md:block" />
                                <span className="text-rtwhite">With world-class expertise, innovative solutions, and a commitment to progress, we deliver clean energy systems that drive operational savings, enhance resilience, and contribute to a sustainable future. </span>
                                <span className="text-rtwhite">We envision a Malaysia where every business leads with purpose and power — and it all starts on the rooftop.</span>
                                <span className="text-rtwhite">A proud member of the Dynasynergy Group</span>
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <div className="container mx-auto px-4 max-w-[1440px] flex justify-center">
                    <div className="w-5/6 mx-auto my-10">
                        <div className="flex flex-col lg:flex-row rounded-xl text-white overflow-hidden">
                            ...
                            <div className="flex-1 lg:border-r-3 lg:pr-12 border-rtyellow-200 text-start lg:text-end">
                                <ScrollReveal>
                                    <h3 className="text-4xl font-semibold text-rtyellow-200 mb-4">Vision</h3>
                            ...
                            <div className="flex-1 pt-[50px] lg:pt-0 lg:pl-12 text-start">
                                <ScrollReveal>
                                    <h3 className="text-4xl font-semibold text-rtyellow-200 mb-4">Mission</h3>
            ...
            <section className="py-32 md:pt-16 bg-rtgray-900">
                <div className="container mx-auto px-4 max-w-[1440px]">
                    <div className="w-5/6 mx-auto text-center text-white">
                        <ScrollReveal>
                            <h2 className="text-3xl font-semibold text-rtyellow-200 mb-12 whitespace-nowrap">
                                Why Rooftop Energy?
                            </h2>
                            <p className="text-xl text-gray-200 leading-relaxed max-w-4xl mx-auto">
                                ...
                                <span className="font-semibold text-rtyellow-200"> advanced software and data analytics</span>. We specialize in enhancing solar PV efficiency for commercial and industrial sectors,
                                <span className="font-semibold text-rtyellow-200"> maximizing performance</span> and returns for our stakeholders.
                            </p>
                        </ScrollReveal>
                    </div>
                </div>
